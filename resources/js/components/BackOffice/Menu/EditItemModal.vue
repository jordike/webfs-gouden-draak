    ...
    <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center bg-black/40" @mousedown.self="$emit('close')">
        <div class="relative w-full max-w-lg rounded bg-white p-8 shadow-lg">
            ...
            <form :action="`/backoffice/menu/${editItemData.id}`" method="post">
                ...
                <div class="mb-4">
                    <label for="edititem-name" class="mb-1 block font-medium text-gray-700">Naam *</label>
                    <input
                        id="edititem-name"
                ...
                <div class="mb-4">
                    <label for="edititem-description" class="mb-1 block font-medium text-gray-700">Beschrijving</label>
                    <textarea
                ...
                <div class="mb-4">
                    <label for="edititem-price" class="mb-1 block font-medium text-gray-700">Prijs (€) *</label>
                    <input
                        id="edititem-price"
                ...
                <div class="mb-4">
                    <label for="edititem-category" class="mb-1 block font-medium text-gray-700">Categorie *</label>
                    <select
