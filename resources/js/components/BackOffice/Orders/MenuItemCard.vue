...
<template>
    <div class="flex items-center justify-between rounded-xl border border-gray-100 bg-white p-5 shadow transition hover:shadow-lg">
        <div class="mb-1">
            <span class="inline-block rounded bg-green-100 px-2 py-0.5 font-mono text-xs font-bold text-green-700 shadow-sm"> #{{ item.id }} </span>
        </div>
